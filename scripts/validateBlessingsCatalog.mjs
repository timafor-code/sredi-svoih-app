...
const allowedAliasCollisions = new Map(
  [
    ...
    ['аль хамихья', ['blessing:mein_shalosh', 'blessing:mein_shalosh_al_hamichya']],
    ...
    ['аль гефен', ['blessing:mein_shalosh', 'blessing:mein_shalosh_al_hagefen']],
    ['ал гефен', ['blessing:mein_shalosh', 'blessing:mein_shalosh_al_hagefen']],
    ...
    ['аль аэц', ['blessing:mein_shalosh', 'blessing:mein_shalosh_al_haetz']],
    ['ал аэц', ['blessing:mein_shalosh', 'blessing:mein_shalosh_al_haetz']],
